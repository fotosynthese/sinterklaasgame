...
public class Game implements ActionListener {
	...
	public void Menu(){
		...
		level1 = new ButtonPanel("1", "The Beginning");
		//level1.setBehaaldeSterren(2);
		level1.startButton.addActionListener(this);
		
		level2 = new ButtonPanel("2", "The Two Towers");
		level2.startButton.addActionListener(this);
		level3 = new ButtonPanel("3", "The Three Musketeers");
		level3.startButton.addActionListener(this);
		level4 = new ButtonPanel("4", "Kwartet");
		level4.startButton.addActionListener(this);
		level5 = new ButtonPanel("5", "Vingers op een Hand");
		level5.startButton.addActionListener(this);
		level6 = new ButtonPanel("6", "Omgekeerde negen!");
		level6.startButton.addActionListener(this);
		level7 = new ButtonPanel("7", "Bijbels nummer");
		level7.startButton.addActionListener(this);
		level8 = new ButtonPanel("8", "90 graden infinity teken");
		level8.startButton.addActionListener(this);
		level9 = new ButtonPanel("9", "Alice's level");
		level9.startButton.addActionListener(this);
		level10 = new ButtonPanel("10", "Inspiratieloos");
		level10.startButton.addActionListener(this);
		level11 = new ButtonPanel("11", "Eerste getal met 2 dezelfde nummers");
		level11.startButton.addActionListener(this);
		level12 = new ButtonPanel("12", "Aantal provincies");
		level12.startButton.addActionListener(this);
		level13 = new ButtonPanel("13", "Gelukkig is het vandaag niet vrijdag");
		level13.startButton.addActionListener(this);
		level14 = new ButtonPanel("14", "Onbetekenisloos getal");
		level14.startButton.addActionListener(this);
		level15 = new ButtonPanel("15", "Aantal trainees");
